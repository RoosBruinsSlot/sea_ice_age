...
def advect_nodes(tri0, u0, v0, max_dist0):
    ...
    if a1.min() < 0:
        for max_dist in [max_dist0, max_dist0*2, max_dist0*3, max_dist0*4 ]: #max_dist0*5, max_dist0*6, max_dist0*7, max_dist0*8, max_dist0*9, max_dist0*10, max_dist0*11, max_dist0*12
